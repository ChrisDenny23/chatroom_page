                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Add a new team member to support staff',
                                      style: TextStyle(
                                        color:
                                            widget
                                                .currentTheme['textSecondary'],
                                  ...
                                  onPressed: () {
                                    if (nameController.text.isNotEmpty) {
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Support member added successfully!',
                                          ),
                                          backgroundColor: Colors.green,
                                          behavior: SnackBarBehavior.floating,
                                          shape: RoundedRectangleBorder(
      ...
      child: Column(
        children: [
          EnhancedHeader(
            ...
            title: 'Server & Support Management',
            subtitle: 'Server Configuration & Support Team',
            description: 'Manage servers, permissions, and support members',
          ),
            ...
            child: Row(
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(
                    selectedTab == 'servers' ? 'Add Server' : 'Add Support',
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Try adjusting your search or add a new server',
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Try adjusting your search or add a new support member',
              style: TextStyle(color: widget.currentTheme['textSecondary']),
            ),
          ],
        ),
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        '${member['ticketsResolved']} tickets',
                        style: TextStyle(
                          color: widget.currentTheme['accent'],
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
              ...
              onSelected: (value) {
                switch (value) {
                  ...
                  case 'delete':
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Support member removed successfully!'),
                        backgroundColor: Colors.red,
                        behavior: SnackBarBehavior.floating,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10),
